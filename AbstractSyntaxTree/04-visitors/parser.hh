...
/**
 ** \file /home/theneonlightning/compilers/Mini-Java-Compiler/AbstractSyntaxTree/04-visitors/parser.hh
...
#ifndef YY_YY_HOME_THENEONLIGHTNING_COMPILERS_MINI_JAVA_COMPILER_ABSTRACTSYNTAXTREE_04_VISITORS_PARSER_HH_INCLUDED
# define YY_YY_HOME_THENEONLIGHTNING_COMPILERS_MINI_JAVA_COMPILER_ABSTRACTSYNTAXTREE_04_VISITORS_PARSER_HH_INCLUDED
...
#line 113 "/home/theneonlightning/compilers/Mini-Java-Compiler/AbstractSyntaxTree/04-visitors/parser.hh"
...
namespace yy {
#line 247 "/home/theneonlightning/compilers/Mini-Java-Compiler/AbstractSyntaxTree/04-visitors/parser.hh"
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<MethodInvExpression>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<MethodInvExpression>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<VarDeclaration>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<VarDeclaration>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<ClassDeclaration>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<ClassDeclaration>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<Expression>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<Expression>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<Statement>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<Statement>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<VarDeclaration>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<VarDeclaration>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 65: // method_invocation
        value.template destroy< std::shared_ptr<MethodInvExpression> > ();
        break;
      ...
      case 49: // class_declarations
        value.template destroy< std::vector<std::shared_ptr<ClassDeclaration>> > ();
        break;
      ...
      case 67: // expressions
        value.template destroy< std::vector<std::shared_ptr<Expression>> > ();
        break;

      case 62: // statements
        value.template destroy< std::vector<std::shared_ptr<Statement>> > ();
        break;

      case 55: // formals
      case 56: // arguments
        value.template destroy< std::vector<std::shared_ptr<VarDeclaration>> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_LESS || tok == token::TOK_GREATER || tok == token::TOK_ASSIGN || tok == token::TOK_ISEQUAL || tok == token::TOK_PLUS || tok == token::TOK_MINUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_RESIDUE || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_LBRACE || tok == token::TOK_RBRACE || tok == token::TOK_LBRACKET || tok == token::TOK_RBRACKET || tok == token::TOK_SEMICOLON || tok == token::TOK_DOT || tok == token::TOK_EXCLAMATION || tok == token::TOK_THIS || tok == token::TOK_TRUE || tok == token::TOK_FALSE || tok == token::TOK_LENGTH || tok == token::TOK_SOPRINTLN || tok == token::TOK_CLASS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_NEW || tok == token::TOK_ASSERT || tok == token::TOK_INT || tok == token::TOK_COLON || tok == token::TOK_IF || tok == token::TOK_ELSE || tok == token::TOK_WHILE || tok == token::TOK_RETURN || tok == token::TOK_EXTENDS || tok == token::TOK_BOOLEAN);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_RESIDUE (location_type l)
      {
        return symbol_type (token::TOK_RESIDUE, std::move (l));
      }
#else
      static
      symbol_type
      make_RESIDUE (const location_type& l)
      {
        return symbol_type (token::TOK_RESIDUE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_EXCLAMATION, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_EXCLAMATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 65: // method_invocation
        value.move< std::shared_ptr<MethodInvExpression> > (std::move (that.value));
        break;
      ...
      case 49: // class_declarations
        value.move< std::vector<std::shared_ptr<ClassDeclaration>> > (std::move (that.value));
        break;
      ...
      case 67: // expressions
        value.move< std::vector<std::shared_ptr<Expression>> > (std::move (that.value));
        break;

      case 62: // statements
        value.move< std::vector<std::shared_ptr<Statement>> > (std::move (that.value));
        break;

      case 55: // formals
      case 56: // arguments
        value.move< std::vector<std::shared_ptr<VarDeclaration>> > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 65: // method_invocation
        value.copy< std::shared_ptr<MethodInvExpression> > (YY_MOVE (that.value));
        break;
      ...
      case 49: // class_declarations
        value.copy< std::vector<std::shared_ptr<ClassDeclaration>> > (YY_MOVE (that.value));
        break;
      ...
      case 67: // expressions
        value.copy< std::vector<std::shared_ptr<Expression>> > (YY_MOVE (that.value));
        break;

      case 62: // statements
        value.copy< std::vector<std::shared_ptr<Statement>> > (YY_MOVE (that.value));
        break;

      case 55: // formals
      case 56: // arguments
        value.copy< std::vector<std::shared_ptr<VarDeclaration>> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 65: // method_invocation
        value.move< std::shared_ptr<MethodInvExpression> > (YY_MOVE (s.value));
        break;
      ...
      case 49: // class_declarations
        value.move< std::vector<std::shared_ptr<ClassDeclaration>> > (YY_MOVE (s.value));
        break;
      ...
      case 67: // expressions
        value.move< std::vector<std::shared_ptr<Expression>> > (YY_MOVE (s.value));
        break;

      case 62: // statements
        value.move< std::vector<std::shared_ptr<Statement>> > (YY_MOVE (s.value));
        break;

      case 55: // formals
      case 56: // arguments
        value.move< std::vector<std::shared_ptr<VarDeclaration>> > (YY_MOVE (s.value));
        break;
...
#endif // !YY_YY_HOME_THENEONLIGHTNING_COMPILERS_MINI_JAVA_COMPILER_ABSTRACTSYNTAXTREE_04_VISITORS_PARSER_HH_INCLUDED
